  ...
  return (
    <div className="flex items-center ">
      ...
      <SwitchPrimitive.Root
        className="transition duration-200 w-[42px] h-[25px] bg-brandGray/30 rounded-full relative outline-none data-[state=checked]:bg-brandPurple-500 focus:outline-brandGray "
        id="profile-private"
      >
